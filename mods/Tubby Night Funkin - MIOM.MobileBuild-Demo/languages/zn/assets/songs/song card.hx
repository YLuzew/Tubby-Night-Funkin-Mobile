...
function create() {
    ...
    songNameText.setFormat(Paths.font("HanYiCaiYunTiJian.ttf"), 30, FlxColor.WHITE, "left");
    ...
    difficultyText.setFormat(Paths.font("HanYiCaiYunTiJian.ttf"), 30, diffColor, "right");
    ...
    composerText = new FlxText(0, 0, 0, "作曲: " + songArtist, 20);
    composerText.setFormat(Paths.font("HanYiCaiYunTiJian.ttf"), 20, FlxColor.WHITE, "left");
