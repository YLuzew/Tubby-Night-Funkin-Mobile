...
function create() {
    ...
    add(weekScore = new FunkinText(10, 290, FlxG.width, 'WEEK SCORE: 0')).setFormat(Paths.font('VCR.ttf'), 25, -1, 'left', Border.OUTLINE, FlxColor.BLACK).borderSize = 2;

    // Back 按钮
    var btnHeight = 64;
    var spacing = 5;
    var btnY = FlxG.height - bottomText.height - btnHeight - spacing;
    backButton = new FunkinText(15, btnY, 0, "Back", 64);
    backButton.setFormat(Paths.font("Tardling-Outline.ttf"), 64, FlxColor.BLACK, "left");
...
function update(elapsed:Float) {
    ...
    weekScore.text = 'WEEK SCORE: ' + Math.round(lerpScore);
