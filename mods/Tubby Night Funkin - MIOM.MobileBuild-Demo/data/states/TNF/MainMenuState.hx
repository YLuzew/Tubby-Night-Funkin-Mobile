...
function create() {
    ...
    tabText = new FunkinText(1050, FlxG.height, 0, 'Open the Mods Menu [TAB]');
    ...
    regenVer = new FunkinText(1007, FlxG.height, 0, 'TubbyNightFunkin - Release V1');
    ...
    // Back 按钮
    backButton = new FunkinText(20, FlxG.height - 60, 0, "Back", 64);
    backButton.setFormat(Paths.font("Tardling-Outline.ttf"), 64, FlxColor.WHITE, "left");
