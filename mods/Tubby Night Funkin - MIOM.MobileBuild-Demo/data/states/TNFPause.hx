...
function create(event) {
    ...
    for (i in 0...numbers.length) {
        ...
        txt.setFormat(Paths.font("Tardling-Outline.ttf"), 120, FlxColor.WHITE, "center");
...
function createOptionCards() {
    ...
    for (i in 0...options.length) {
        ...
        txt.setFormat(Paths.font("Tardling-Outline.ttf"), 75, FlxColor.WHITE, "center");
...
function createSongInfoTexts() {
    ...
    songNameText.setFormat(Paths.font("Tardling-Outline.ttf"), 36, FlxColor.WHITE, "left");
    ...
    composerText.setFormat(Paths.font("Tardling-Outline.ttf"), 28, FlxColor.WHITE, "right");
    ...
    difficultyText.setFormat(Paths.font("Tardling-Outline.ttf"), 36, diffColor, "left");
