...
class Main extends Sprite
{
	...
	public static var modToLoad:String = 'Tubby Night Funkin - MIOM.MobileBuild-Demo';
	...
	public static function loadGameSettings() {
		...
		var targetMod = modToLoad != null && modToLoad.trim() != "" ? modToLoad : Options.lastLoadedMod;
