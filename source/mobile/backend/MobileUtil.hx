...
class MobileUtil
{
	...
	public static inline function getAssetDirectory():String
		return #if android haxe.io.Path.addTrailingSlash("/sdcard/Android/data/com.MIOMBuild.TubbyNightFunkin/files") #elseif ios lime.system.System.documentsDirectory #else Sys.getCwd() #end;
	...
	public static function initDirectory():String {
		...
		switch(curStorageType) {
			case 'EXTERNAL':
				daPath = "/sdcard/.TubbyNightFunkin";
			/* obb doesnt work and I dont wanna fix it -ArkoseLabs
			case 'EXTERNAL_OBB':
				daPath = "/sdcard/Android/obb/com.yoshman29.codenameengine";
			*/
			case 'EXTERNAL_MEDIA':
				daPath = "/sdcard/Android/media/com.MIOMBuild.TubbyNightFunkin";
			case 'EXTERNAL_DATA':
				daPath = "/sdcard/Android/data/com.MIOMBuild.TubbyNightFunkin/files";
			default: //technically not needed but here for safety -ArkoseLabs
				if (daPath == null || daPath == '') daPath = "/sdcard/Android/data/com.MIOMBuild.TubbyNightFunkin/files";
		}
